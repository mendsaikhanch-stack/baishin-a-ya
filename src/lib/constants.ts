// ============================================================
// Байшин А-Я — Application Constants
// ============================================================

export const APP_NAME = "Байшин А-Я";
...
export const DISCLAIMER_TEXT =
  "Энэхүү апп нь зөвхөн төлөвлөлт, мэдээлэл өгөх зорилготой бөгөөд мэргэжлийн архитектор, инженер, барилгын зөвшөөрлийг орлохгүй. Бүх барилга угсралтын ажлыг эрх бүхий мэргэжилтнээр хийлгэнэ үү.";
